...
=======
    ...
    Route::get('/data-pegawai-json', [PengusulController::class, 'getPegawaiJson'])->name('get.pegawai.json');
    Route::get('/data-mahasiswa-json', [PengusulController::class, 'getMahasiswaJson'])->name('get.mahasiswa.json');
