...
<div class="pengusulan-container px-4 py-3">
  <h1 class="pengusulan-page-title mb-4">Pengusulan</h1>
    ...
    <div class="p-4 shadow-sm bg-white rounded">
      <form id="pengusulanForm" action="{{ route('pengusul.store.pengusulan') }}" method="POST" enctype="multipart/form-data">
        ...
        <div id="initial-form" class="form-step-active">
          <div class="row">
            <!-- Form Bagian Kiri -->
            <div class="col-md-6">
              <!-- Nama Kegiatan -->
          ...
          <div class="col-md-6">
            <!-- Ditugaskan Sebagai -->
            <div class="mb-3 mt-4">
                <label for="namaPenyelenggara" class="form-label">Nama Penyelenggara Kegiatan</label>
                <input type="text" class="form-control" id="namaPenyelenggara" name="namaPenyelenggara" placeholder="Nama Penyelenggara Kegiatan" required value="{{ old('namaPenyelenggara') }}">
              </div>
        ...
        <div id="data-section" class="form-step-active">
            <h3>Data Personel</h3>
...
@push('styles')
    <link rel="stylesheet" href="{{ asset('css/surat-tugas.css') }}">
    <link rel="stylesheet" href="//code.jquery.com/ui/1.13.2/themes/base/jquery-ui.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css" />
@endpush

@push('scripts')
  <script src="{{ asset('js/surat-tugas.js') }}"></script>
@endpush
<script>
    window.paguDesentralisasi = {{ old('pagu_desentralisasi') ? 'true' : 'false' }};
    window.pembiayaan = "{{ old('pembiayaan', 'Polban') }}";
</script>
